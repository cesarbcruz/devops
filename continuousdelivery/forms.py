...
class DeployForm(forms.Form):
    ...
    def execute(self, request):
        ...
        try:
            ...
            DeployRun.archive_binaries(global_parameters.folder_archive_binaries, version, logger, binary_files)
            ...
            DeployRun.send_binaries(server_jboss.ip, binary_files, folder_destination, server_jboss.user_ssh, server_jboss.password_ssh, logger, server_jboss.jboss_home, server_jboss.erp_home, (self.cleaned_data['type_deploy']))
